...
export default function Footer() {
  return (
    <footer className="flex justify-center pt-6">
      <a className="mr-6 text-storm-gray hover:text-white" href="https://linkedin.com/in/asjasroos">
      ...
      <a className="mr-6 text-storm-gray hover:text-white" href="https://github.com/asjas">
        <svg className="w-10 h-10" viewBox="0 0 128 128">
          <title>Github</title>
          <g fill="currentColor">
            <path
      ...
      <a className="text-storm-gray hover:text-white" href="https://twitter.com/_asjas">
        <svg className="w-10 h-10 mt-1" viewBox="0 0 128 128">
          <title>Twitter</title>
          <g fill="currentColor">
            <path
              id="original"
