...
const HamburgerIcon: React.FunctionComponent<Props> = ({ handleClick, handleKeyDown }): React.ReactElement => (
...
const CloseIcon: React.FunctionComponent<Props> = ({ handleClick, handleKeyDown }): React.ReactElement => (
  <Styled.HamburgerMenu
    onClick={handleClick}
    onKeyDown={handleKeyDown}
    tabIndex={0}
