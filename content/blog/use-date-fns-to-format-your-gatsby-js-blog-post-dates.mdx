...
Now that we have Gatsby.js and date-fns installed we can now use date-fns to format the dates of our blog posts. In this first example we will be making the following changes to the main page and the individual post pages.
...
Here are a few examples of different format parameters passed to the `format` function and the output you would receive.
