...
date: 2019-02-03T14:30:21.617Z
updated_at: 2019-06-09T14:30:21.679Z
featured_image: /assets/node-nextick-image.jpeg
tags:
  - javascript
  - node
---
...
_**tldr**: A function or functions passed to `process.nextTick()` will be executed **before** the next tick of the JS engine and **not in** the following tick. It can be intuitive to assume that `nextTick` means the following tick but it does in fact execute code before next tick._
