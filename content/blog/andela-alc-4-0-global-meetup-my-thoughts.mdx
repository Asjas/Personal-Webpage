...
5. [Flexbox Zombies](https://flexboxzombies.com/p/flexbox-zombies)
6. [CSS-Tricks](https://css-tricks.com/)
7. [The Modern JavaScript Tutorial](http://javascript.info/)
8. [A Gamified Learning Platform](https://mentored.dev)
9. [What The Flexbox](https://flexbox.io/)
10. [CSS Grid](https://cssgrid.io/)
