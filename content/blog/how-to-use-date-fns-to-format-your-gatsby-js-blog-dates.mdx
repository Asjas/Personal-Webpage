...
In the same folder where you ran `npm run develop` you can run the following command to install date-fns. We will be installing the latest version as this is the version that supports all of the new functions that we will be using. 
