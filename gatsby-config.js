  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        allPageHeaders: [
          'Content-Security-Policy: report-uri https://asjas.report-uri.com/r/d/csp/wizard; report-to default',
          'X-Content-Security-Policy: report-uri https://asjas.report-uri.com/r/d/csp/reportOnly; report-to default',
          'Expect-CT: max-age=604800; report-uri https://asjas.report-uri.com/r/d/ct/reportOnly; report-to default',
          'Expect-Staple: max-age=604800; report-uri=https://asjas.report-uri.com/r/d/staple/reportOnly; report-to default',
          'Referrer-Policy: same-origin',
          'Strict-Transport-Security: max-age=2592000',
          'X-Content-Type-Options: nosniff',
          'X-Frame-Options: DENY',
          'X-XSS-Protection: 1; mode=block; report-uri https://asjas.report-uri.com/r/d/xss/enforce; report-to default',
          "Feature-Policy: geolocation 'none'; camera 'none'; payment 'none'; usb 'none'; midi 'none'",
          "Report-To: {'group':'default','max_age':31536000,'endpoints':[{'url':'https://asjas.report-uri.com/a/d/g'}]}",
        ],
